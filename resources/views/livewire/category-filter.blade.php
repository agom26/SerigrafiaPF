    ...
    <div class="bg-white rounded-lg shadow-lg mb-6">
        <div class="px-6 py-2 flex justify-between items-center">
            ...
            <div class="grid grid-cols-2 border border-gray-200 divide-x divide-gray-200 text-gray-500">
                <i class="fas fa-border-all p-3 cursor-pointer {{$view=='grid' ? 'text-red-500' : ''}}" wire:click="$set('view','grid')"></i>
                <i class="fas fa-th-list p-3 cursor-pointer {{$view=='list' ? 'text-red-500' : ''}}" wire:click="$set('view','list')"></i>
            </div>
        </div>
    </div>
                ...
                <li class="bg-white rounded-lg shadow ">
                    <article>
                        ...
                        <div class="py-4 px-6">
                            ...
                            <p class="font-bold text-neutral-700">Q{{$product->price}}</p>
                        </div>
                    </article>
